...
//Get Model -> From URDF can obtain rbdl model, joint names, joint pos min and max, joint vel min and max, ...
  ...
  arm_right_model_.AppendBody(*arm_right_model_.getModelData(), rbdl_model_.GetJointFrame(57), rbdl_model_.mJoints[57], rbdl_model_.mBodies[57], "arm_right_1_link");
  arm_right_model_.AppendBody(*arm_right_model_.getModelData(), rbdl_model_.GetJointFrame(58), rbdl_model_.mJoints[58], rbdl_model_.mBodies[58], "arm_right_2_link");
  arm_right_model_.AppendBody(*arm_right_model_.getModelData(), rbdl_model_.GetJointFrame(59), rbdl_model_.mJoints[59], rbdl_model_.mBodies[59], "arm_right_3_link");
  arm_right_model_.AppendBody(*arm_right_model_.getModelData(), rbdl_model_.GetJointFrame(60), rbdl_model_.mJoints[60], rbdl_model_.mBodies[60], "arm_right_4_link");
  arm_right_model_.AppendBody(*arm_right_model_.getModelData(), rbdl_model_.GetJointFrame(61), rbdl_model_.mJoints[61], rbdl_model_.mBodies[61], "arm_right_5_link");
  arm_right_model_.AppendBody(*arm_right_model_.getModelData(), rbdl_model_.GetJointFrame(62), rbdl_model_.mJoints[62], rbdl_model_.mBodies[62], "arm_right_6_link");
  arm_right_model_.AppendBody(*arm_right_model_.getModelData(), rbdl_model_.GetJointFrame(63), rbdl_model_.mJoints[63], rbdl_model_.mBodies[63], "arm_right_7_link");
 ...
 // RigidBodyDynamics::ModelDatad model_data_ = *rbdl_model_.getModelData();
   ...
   while(ros::ok()){
    ...
    /*
       cout<<"Joints: "<<endl;
       cout<<"Size: "<<rbdl_model_.mJoints.size()<<endl;

       for(int i=14; i<64; i++){

          cout<<rbdl_model_.GetBodyName(i)<<"     index:     "<<i<<endl;
 ...
 //   G_r_.setZero(6, dofs_);
  ...
  //  lin_vel_l_={vel_l_[3], vel_l_[4], vel_l_[5]};
    ...
    Eigen::Vector3d pos_l_;
    pos_l_.resize(3);
    pos_l_.setZero();
    Eigen::Vector3d pos_r_;
    pos_r_.resize(3);
    pos_r_.setZero();
...
*/
  ...
  cout<<"\n";
  cout << "Extraction concluded" << endl;
