...
{
bool GravityCompensation::initRequest(hardware_interface::RobotHW* robot_hw,
...
bool GravityCompensation::init(hardware_interface::EffortJointInterface* effort_iface, hardware_interface::JointStateInterface* joint_state_iface, ros::NodeHandle& /*root_nh*/, ros::NodeHandle& control_nh){
